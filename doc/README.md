...
Вершины могут обозначать события, а связи - взаимосвязи между ними, тогда граф отображает причинно-следственные 
связи.

Итак, граф состоит из вершин и ребер их соединяющих. Вершины могут иметь различные типы,
и различную дополнительную информацию, специфичную для этого типа. Если вершина обозначает человека,
...
* Факт - установленное множество вершин и ребер отражающих какое-либо событие, процесс, явление. 
